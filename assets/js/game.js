...
var fightOrSkip = function () {
    ...
    if (promptFight === "skip") {
        ...
        if (confirmSkip) {
            window.alert(playerInfo.name + " has decide to skip this fight. Goodbye!");
...
if (Math.random() > 0.5){
    ...
    while (playerInfo.health > 0 && enemy.health > 0 ){
        ...
        if (playerInfo.health <= 0) {
            ...
            // leave while() loop if player if dead
            break;
        }
        else{
...
var endGame = function() {
    ...
    if (highScore === null){
        highScore = 0;
        // short circuit conditional statement : highScore = highScore || 0;
    }
    // if player has more money than the higher score, player has new higher score!
